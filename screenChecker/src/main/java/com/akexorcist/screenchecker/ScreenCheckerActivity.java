...
public class ScreenCheckerActivity extends Activity {
    ...
    private ViewTreeObserver.OnGlobalLayoutListener globalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
        ...
        public void onGlobalLayout() {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                textViewMultiAppResolutionPx.setText(ScreenUtility.getAppResolutionPx(ScreenCheckerActivity.this, rootView));
                textViewMultiAppResolutionDp.setText(ScreenUtility.getAppResolutionDp(ScreenCheckerActivity.this, rootView));
            } else {
                textViewSingleAppResolutionPx.setText(ScreenUtility.getAppResolutionPx(ScreenCheckerActivity.this, rootView));
                textViewSingleAppResolutionDp.setText(ScreenUtility.getAppResolutionDp(ScreenCheckerActivity.this, rootView));
            }
        }
    };
